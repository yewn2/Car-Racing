"""
Car Racing Version 5
This version implements the scoring function and also takes inputs from the menu.
"""
...
import sys
import os
import menu_3 as menu  # this will be changed to an updated final version later
